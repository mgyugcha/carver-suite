...
const escritorio = new servidorbayes.State('Escritorio')
const librero = new servidorbayes.State('Librero')
const piso2 = new servidorbayes.State('Piso2')
const piso3 = new servidorbayes.State('Piso3')
const piso4 = new servidorbayes.State('Piso4')
const b = new servidorbayes.Node('B', [escritorio, librero, piso2, piso3, piso4])
...
const c = new servidorbayes.Node('C', [cLiviano, cMediano, cPesado])
// generar las variables para el nodo d
const seg10 = new servidorbayes.State('Segundo10')
const seg30 = new servidorbayes.State('Segundo30')
const seg65 = new servidorbayes.State('Segundo65')
const d = new servidorbayes.Node('D', [seg10, seg30, seg65])

const volt6 = new servidorbayes.State('Voltaje6')
const volt7 = new servidorbayes.State('Voltaje7')
const volt8 = new servidorbayes.State('Voltaje8')
const volt9 = new servidorbayes.State('Voltaje9')
const volt12 = new servidorbayes.State('Voltaje12')
const e = new servidorbayes.Node('E', [volt6, volt7, volt8, volt9, volt12])

const seg10m = new servidorbayes.State('Segundo10m')
const seg15m = new servidorbayes.State('Segundo15m')
const seg20m = new servidorbayes.State('Segundo20m')
const f = new servidorbayes.Node('F', [seg10m, seg15m, seg20m])
...
network.links.push(new servidorbayes.Link(a, e))
network.links.push(new servidorbayes.Link(a, f))
